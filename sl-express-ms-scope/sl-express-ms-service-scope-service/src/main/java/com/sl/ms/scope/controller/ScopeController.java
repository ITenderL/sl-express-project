...
public class ScopeController {
    ...
    @GetMapping("/near")
    public ResponseEntity<List<Long>> queryNearUser(@RequestParam("userId") Long userId, @RequestParam("metre")Double metre) {
        List<Long> userIdList = this.scopeService.queryNearUser(userId, metre);
        return ResponseEntityUtils.ok(userIdList);
    }
